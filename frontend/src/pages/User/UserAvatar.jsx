...
<<<<<<< HEAD
        {!loading && (
          ...
          <div
            ...
            className=" skeleton w-full h-full absolute inset-0 flex items-center justify-center cursor-pointer"
          >
            <span className="w-32 skeleton h-32 rounded-full bg-gray-200 flex items-center justify-center">
