...
app.use(cors({
    origin: ['https://socialnetwork-frontend-u1b0.onrender.com','http://localhost:5173','https://social-network-amber.vercel.app/', 'http://localhost:3000', 'http://localhost:4000', 'http://localhost:3000/api'],
    credentials: true
}));
